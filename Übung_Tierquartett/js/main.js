...
const animalNames = ['Cheetah', 'Elephant', 'Lion', 'Tiger', 'Giraffe','Whale Shark','Polar Bear','Scorpion','Hyena','Wandering Spider','Mosquito','Poison Dart Frog','Crocodile','Cobra','Komodo Dragon','Galapagos Tortoise']; // Beispiel-Tiernamen
                    ...
                    characteristics.forEach(item => {
                        ...
                        if (element) {
                            if (item.setting === 'Properties') {
                                element.textContent = `${item.name}: ${animal[item.attribute]}`;
